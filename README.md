...
> [!IMPORTANT]
> MVP (_Minimal Viable Product_, ou Produto Mínimo Viável) é a versão mais simples de um produto, contendo apenas o essencial para validar uma ideia. Este projeto segue esse conceito, com foco em arquitetura limpa, boas práticas e qualidade de código, priorizando o essencial em vez do volume de funcionalidades.
